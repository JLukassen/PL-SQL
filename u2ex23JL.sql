...
CREATE TABLE mm_movie (
  ...
  CONSTRAINT movies_value_ck CHECK (
    movie_value BETWEEN 5
    AND 100
  )
);
...
CREATE sequence mm_rental_seqstart WITH 13;
INSERT INTO
  mm_member (
    member_id,
    last,
...
INSERT INTO
  mm_movie_type (movie_cat_id, movie_category)
VALUES
  ('1', 'SciFi');
INSERT INTO
  mm_movie_type (movie_cat_id, movie_category)
...
INSERT INTO
  mm_pay_type (payment_methods_id, payment_methods)
VALUES
  ('1', 'Account');
INSERT INTO
  mm_pay_type (payment_methods_id, payment_methods)
...
VALUES
  (12, '13', '4', '5');
UPDATE
  mm_rental SET checkout_date = '04-JUN-2012';
COMMIT;
